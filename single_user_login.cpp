...
public:
    void correct_third_step(User *thirdverifyobj){
        ...
        if(verfiy_imei_number==thirdverifyobj[0].imei_no && verify_previous_location==thirdverifyobj[0].location && verify_mobile_no==thirdverifyobj[0].mobile_no){
...
int main(){
    ...
    obj[0].password=encrypt("khan");
    obj[0].pin=6789;
    obj[0].imei_no="rtyu78";
    obj[0].location=23;
